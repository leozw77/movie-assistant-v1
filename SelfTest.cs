...
public static class SelfTest
{
    public static string Run()
    {
        ...
        try
        {
            ...
            embeddedReadOk = cardScript.Contains("QbDoubanCard", StringComparison.Ordinal) && cardScript.Contains("qb-media-card-my-rating", StringComparison.Ordinal) && shellScript.Contains("qb-douban-shell-root", StringComparison.Ordinal) && personalSourceBridge.Contains("readPersonalFilters", StringComparison.Ordinal) && shellScript.Contains("doubanShellApplyLocalPersonalFilter", StringComparison.Ordinal) && shellScript.Contains("doubanShellPersonalItemMutation", StringComparison.Ordinal) && shellScript.Contains("qb-shell-personal-primary-row", StringComparison.Ordinal) && shellScript.Contains("qb-shell-score-popover", StringComparison.Ordinal) && shellScript.Contains("qb-shell-score-track", StringComparison.Ordinal) && shellScript.Contains("qb-shell-score-handle", StringComparison.Ordinal) && shellScript.Contains("personalAdvancedFilterSection", StringComparison.Ordinal) && shellScript.Contains("frodo-local-index", StringComparison.Ordinal);
        }
        catch { }
