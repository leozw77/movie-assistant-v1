...
public static class SelfTest
{
    public static string Run()
    {
        ...
        try
        {
            ...
            embeddedReadOk = cardScript.Contains("QbDoubanCard", StringComparison.Ordinal) && cardScript.Contains("qb-media-card-my-rating", StringComparison.Ordinal) && shellScript.Contains("qb-douban-shell-root", StringComparison.Ordinal) && personalSourceBridge.Contains("readPersonalFilters", StringComparison.Ordinal) && shellScript.Contains("doubanShellApplyPersonalFilter", StringComparison.Ordinal) && shellScript.Contains("doubanShellApplyLocalPersonalFilter", StringComparison.Ordinal) && shellScript.Contains("doubanShellPersonalItemMutation", StringComparison.Ordinal) && shellScript.Contains("qb-shell-advanced-filter-panel", StringComparison.Ordinal) && shellScript.Contains("frodo-local-index", StringComparison.Ordinal);
        }
        catch { }
